...
async fn test_route_registration() {
    let app = test::init_service(
        App::new()
            .configure(media_gateway_discovery::server::configure_routes)
    )
    .await;
...
async fn test_search_routes_registered() {
    ...
    assert_ne!(resp.status(), 404, "Search POST endpoint should be registered");
    ...
    let req = test::TestRequest::get()
        ...
        .to_request();
    let resp = test::call_service(&app, req).await;
    assert_ne!(resp.status(), 404, "Autocomplete GET endpoint should be registered");
}
...
async fn test_analytics_routes_registered() {
    ...
    let req = test::TestRequest::get()
        ...
        .to_request();
    let resp = test::call_service(&app, req).await;
    assert_ne!(resp.status(), 404, "Analytics endpoint should be registered");
}
...
async fn test_quality_routes_registered() {
    ...
    let req = test::TestRequest::get()
        ...
        .to_request();
    let resp = test::call_service(&app, req).await;
    assert_ne!(resp.status(), 404, "Quality report endpoint should be registered");
}
...
async fn test_ranking_routes_registered() {
    ...
    let req = test::TestRequest::get()
        ...
        .to_request();
    let resp = test::call_service(&app, req).await;
    assert_ne!(resp.status(), 404, "Get ranking config endpoint should be registered");
    ...
    let req = test::TestRequest::get()
        ...
        .to_request();
    let resp = test::call_service(&app, req).await;
    assert_ne!(resp.status(), 404, "List variants endpoint should be registered");
    ...
    let req = test::TestRequest::get()
        ...
        .to_request();
    let resp = test::call_service(&app, req).await;
    assert_ne!(resp.status(), 404, "Get variant endpoint should be registered");
    ...
    let req = test::TestRequest::get()
        ...
        .to_request();
    let resp = test::call_service(&app, req).await;
    assert_ne!(resp.status(), 404, "Get history endpoint should be registered");
}
...
async fn test_catalog_routes_still_registered() {
    ...
    let req = test::TestRequest::post()
        ...
        .to_request();
    let resp = test::call_service(&app, req).await;
    assert_ne!(resp.status(), 404, "Catalog content endpoint should be registered");
}
